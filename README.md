...
<img src='./app-preview.gif' style='width: 100%; max-width: 500px' alt='animated GIF image with app preview'>
...
3. Run `npm install` for this project
4. Fill in configuration options in `src/environments/environment.ts` file
